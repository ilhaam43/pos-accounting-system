            ...
            <div class="container-fluid">
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Laporan Transaksi Penjualan</a></li>
                        </ol>
                    </div>
                    </div>
                <!-- row -->
                    ...
                    <div class="col-6">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Generate Laporan Transaksi Penjualan</h4>
                            </div>
                            <div class="card-body">
        ...
        ***********************************-->
        ...
        @push('custom-scripts')
            ...
            function generateReport(month) {
                window.open("/export/pdf/sales-transactions" + "/" + month, "_blank");
            }
            </script>
        @endpush
